const generatePrompt = (customerName) => {
  ...
  const prompt = `
    ...
    CATEGORÍAS & PRODUCTOS:
      ...
      La respuesta tiene que ser corta para whatsapp: La Categoria es {category} {description},  puedes revisar más detalles en nuestro Ecommerce superfuds.com/categoria/{id}
    ...
    Cuando te pregunte por una marca usa de este listado:
      ...
      La respuesta tiene que ser corta para whatsapp: La marca es {name} {info}, y corta para whatsapp, puedes revisar más detalles en nuestro ecommerce superfuds.com/marca/{id}
